      ...
      <div className="mx-auto max-w-[1200px] px-4 pb-7 pt-6 sm:px-6 lg:px-10 lg:pb-8 lg:pt-8">
        <div className="lg:grid lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
          <div>
            ...
            />
            <p className="mt-2 max-w-[330px] text-[12px] font-normal leading-[1.7] text-[var(--text-secondary)]">
        ...
        <div className="mt-5 border-t border-[rgba(222,212,200,0.72)] pt-3.5 text-[11px] font-normal leading-[1.5] text-[#94877c]">
          © 2026 烟斗派 YandouBuy
        </div>
      </div>
    </footer>
