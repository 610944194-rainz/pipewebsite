...
export type DemoWorkSeed = Omit<DemoMakerProduct, "images" | "isDemo" | "source">;

export const demoWorkSeeds: readonly DemoWorkSeed[] = [
  { id: "demo-lin-yan-straight-billiard-01", slug: "demo-lin-yan-straight-billiard-01", sourceProductId: "danish-1658", makerSlug: "demo-maker-lin-yan", nameZh: "经典直式撞球斗", nameEn: "Classic Straight Billiard", shape: "直式撞球斗", bowlMaterial: "石楠木", finish: "光面", stemMaterial: "亚克力", filterSpec: "9 mm", weightGrams: 42.6, lengthMillimeters: 145, bowlHeightMillimeters: 46, bowlWidthMillimeters: 35.8, chamberDiameterMillimeters: 19.2, chamberDepthMillimeters: 37.5, availability: "available", demoReferencePrice: 1680, description: "以平衡比例与日常持握感为重点的示例作品。" },
  { id: "demo-lin-yan-bent-billiard-02", slug: "demo-lin-yan-bent-billiard-02", sourceProductId: "smokingpipes-612581", makerSlug: "demo-maker-lin-yan", nameZh: "弯式喷砂撞球斗", nameEn: "Bent Sandblasted Billiard", shape: "弯式撞球斗", bowlMaterial: "石楠木", finish: "喷砂", stemMaterial: "硬化橡胶", filterSpec: "无滤芯", weightGrams: 46.8, lengthMillimeters: 138.5, bowlHeightMillimeters: 47.2, bowlWidthMillimeters: 36.4, chamberDiameterMillimeters: 19, chamberDepthMillimeters: 38, availability: "available", demoReferencePrice: 1880, description: "强调烟道连贯与重心控制的弯式示例作品。" },
  { id: "demo-lin-yan-dublin-03", slug: "demo-lin-yan-dublin-03", sourceProductId: "danish-342", makerSlug: "demo-maker-lin-yan", nameZh: "细收都柏林斗", nameEn: "Tapered Dublin", shape: "都柏林斗", bowlMaterial: "石楠木", finish: "锈面", stemMaterial: "亚克力", filterSpec: "9 mm", weightGrams: 40.3, lengthMillimeters: 149, bowlHeightMillimeters: 48.6, bowlWidthMillimeters: 34.6, chamberDiameterMillimeters: 18.7, chamberDepthMillimeters: 38.5, availability: "sold-reference", demoReferencePrice: 1980, description: "用于测试线条与细收斗钵展示的已售参考作品。" },
  { id: "demo-lin-yan-apple-04", slug: "demo-lin-yan-apple-04", sourceProductId: "danish-16307", makerSlug: "demo-maker-lin-yan", nameZh: "日常苹果斗", nameEn: "Everyday Apple", shape: "苹果斗", bowlMaterial: "石楠木", finish: "光面", stemMaterial: "硬化橡胶", filterSpec: "无滤芯", weightGrams: 44.1, lengthMillimeters: 136, bowlHeightMillimeters: 45.4, bowlWidthMillimeters: 39.2, chamberDiameterMillimeters: 19.1, chamberDepthMillimeters: 36.8, availability: "sold-reference", demoReferencePrice: 1760, description: "圆润斗钵比例的已售参考作品。" },
  { id: "demo-muchuan-straight-billiard-01", slug: "demo-muchuan-straight-billiard-01", sourceProductId: "danish-7498", makerSlug: "demo-studio-muchuan", nameZh: "光面直式撞球斗", nameEn: "Smooth Straight Billiard", shape: "直式撞球斗", bowlMaterial: "石楠木", finish: "光面", stemMaterial: "亚克力", filterSpec: "9 mm", weightGrams: 48.5, lengthMillimeters: 142, bowlHeightMillimeters: 49, bowlWidthMillimeters: 39, chamberDiameterMillimeters: 19.5, chamberDepthMillimeters: 39, availability: "available", demoReferencePrice: 2180, description: "突出天然木纹与圆润底部轮廓的示例作品。" },
  { id: "demo-muchuan-bent-billiard-02", slug: "demo-muchuan-bent-billiard-02", sourceProductId: "smokingpipes-625207", makerSlug: "demo-studio-muchuan", nameZh: "锈面弯式撞球斗", nameEn: "Rusticated Bent Billiard", shape: "弯式撞球斗", bowlMaterial: "石楠木", finish: "锈面", stemMaterial: "硬化橡胶", filterSpec: "无滤芯", weightGrams: 47.3, lengthMillimeters: 140.5, bowlHeightMillimeters: 48.1, bowlWidthMillimeters: 37.2, chamberDiameterMillimeters: 19.2, chamberDepthMillimeters: 38.4, availability: "sold-reference", demoReferencePrice: 2260, description: "以手工纹理与稳定曲线为重点的已售参考作品。" },
  { id: "demo-muchuan-brandy-03", slug: "demo-muchuan-brandy-03", sourceProductId: "danish-35271", makerSlug: "demo-studio-muchuan", nameZh: "天然白兰地斗", nameEn: "Natural Brandy", shape: "白兰地斗", bowlMaterial: "石楠木", finish: "光面", stemMaterial: "亚克力", filterSpec: "9 mm", weightGrams: 43.8, lengthMillimeters: 139.2, bowlHeightMillimeters: 46.3, bowlWidthMillimeters: 38.6, chamberDiameterMillimeters: 19, chamberDepthMillimeters: 37.2, availability: "available", demoReferencePrice: 1940, description: "以自然木纹与饱满轮廓为方向的示例作品。" },
  { id: "demo-muchuan-dublin-04", slug: "demo-muchuan-dublin-04", sourceProductId: "danish-3827", makerSlug: "demo-studio-muchuan", nameZh: "轻量都柏林斗", nameEn: "Lightweight Dublin", shape: "都柏林斗", bowlMaterial: "石楠木", finish: "喷砂", stemMaterial: "硬化橡胶", filterSpec: "9 mm", weightGrams: 39.6, lengthMillimeters: 147, bowlHeightMillimeters: 47.5, bowlWidthMillimeters: 34.8, chamberDiameterMillimeters: 18.8, chamberDepthMillimeters: 37.8, availability: "sold-reference", demoReferencePrice: 2080, description: "用于测试轻量化与喷砂表面信息的已售参考作品。" },
  { id: "demo-muchuan-reverse-calabash-05", slug: "demo-muchuan-reverse-calabash-05", sourceProductId: "danish-2645", makerSlug: "demo-studio-muchuan", nameZh: "葫芦结构作品", nameEn: "Calabash Form", shape: "葫芦斗", bowlMaterial: "石楠木", finish: "自然表面", stemMaterial: "亚克力", filterSpec: "无滤芯", weightGrams: 54.2, lengthMillimeters: 151.5, bowlHeightMillimeters: 52, bowlWidthMillimeters: 41.5, chamberDiameterMillimeters: 19, chamberDepthMillimeters: 34.2, availability: "available", demoReferencePrice: 2480, description: "用于验证葫芦结构与完整尺寸字段的示例作品。" },
  { id: "demo-zhou-yu-freehand-blowfish-01", slug: "demo-zhou-yu-freehand-blowfish-01", sourceProductId: "danish-33109", makerSlug: "demo-maker-zhou-yu", nameZh: "自由式河豚斗", nameEn: "Freehand Blowfish", shape: "自由式河豚斗", bowlMaterial: "石楠木", finish: "自然表面", stemMaterial: "亚克力", filterSpec: "无滤芯", weightGrams: 51.8, lengthMillimeters: 156, bowlHeightMillimeters: 51, bowlWidthMillimeters: 42.8, chamberDiameterMillimeters: 19.3, chamberDepthMillimeters: 38.6, availability: "available", demoReferencePrice: 2380, description: "以自由线条与局部纹理关系为重点的示例作品。" },
  { id: "demo-zhou-yu-freehand-brandy-02", slug: "demo-zhou-yu-freehand-brandy-02", sourceProductId: "danish-35265", makerSlug: "demo-maker-zhou-yu", nameZh: "喷砂白兰地斗", nameEn: "Sandblasted Brandy", shape: "白兰地斗", bowlMaterial: "石楠木", finish: "喷砂", stemMaterial: "亚克力", filterSpec: "无滤芯", weightGrams: 49.4, lengthMillimeters: 148, bowlHeightMillimeters: 49.6, bowlWidthMillimeters: 40.4, chamberDiameterMillimeters: 19.4, chamberDepthMillimeters: 38.2, availability: "sold-reference", demoReferencePrice: 2150, description: "用于测试自由式描述、尺寸与示例参考价的已售参考作品。" },
